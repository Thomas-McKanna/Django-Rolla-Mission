...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Patron',
            fields=[
                ('headshot', models.ImageField(blank=True, null=True, storage=rolla_mission.storage_backends.PrivateMediaStorage(), upload_to='')),
                ...
                ('_id', models.CharField(default=uuid.UUID('06e3ae58-8c3a-4924-ade2-3eca49690add'), max_length=100, primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='CheckIn',
